#
#  Be sure to run `pod spec lint TvsIosFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Minh Nguyen" => "nhminh1@tma.com.vn" }
  # Or just: spec.author    = "Minh Nguyen"
  # spec.authors            = { "Minh Nguyen" => "nhminh1@tma.com.vn" }
  # spec.social_media_url   = "https://twitter.com/Minh Nguyen"
  ...
  spec.source       = { :git => "https://github.com/minh-nguyen-tma/tvs-ios-sdk.git", :tag => "#{spec.version}" }
